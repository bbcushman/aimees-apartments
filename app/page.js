  ...
  return (
    <div className="min-h-screen bg-stone-50 text-gray-900" style={{fontFamily: "'Georgia', serif"}}>
      ...
      <nav className={`sticky top-0 z-50 transition-all duration-300 ${scrolled ? "bg-white shadow-md" : "bg-white/90 backdrop-blur-sm"} border-b border-stone-200`}>
        ...
        {menuOpen && (
          <div className="md:hidden bg-white border-t border-stone-100 px-8 py-4 flex flex-col gap-3 text-sm text-stone-600" style={{fontFamily: "sans-serif"}}>
            <a href="/">Home</a>
      ...
      {/* Hero */}
      <div className="max-w-5xl mx-auto px-8 pt-14 pb-10 grid md:grid-cols-5 gap-12 items-center">
        {/* Left — 3 cols */}
        <div className="md:col-span-3">
          ...
          <h1 className="text-5xl font-bold text-stone-900 leading-tight mb-5" style={{letterSpacing: "-1px"}}>
            A broker who<br/>
      ...
      <div className="max-w-5xl mx-auto px-8 pb-12">
        <div className="grid grid-cols-4 gap-2 h-40 rounded-2xl overflow-hidden">
          ...
          <img src="https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9?w=400&q=80" className="w-full h-full object-cover" alt="NYC" />
          <img src="https://images.unsplash.com/photo-1534430480872-3498386e7856?w=400&q=80" className="w-full h-full object-cover" alt="Central Park" />
        </div>
      </div>

      {/* Divider */}
      <div className="border-t border-stone-200 max-w-5xl mx-auto px-8" />

      {/* For Renters + For Buildings — side by side */}
      <div className="max-w-5xl mx-auto px-8 py-12 grid md:grid-cols-2 gap-12">
