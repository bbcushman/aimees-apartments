  ...
  return (
    <div className="min-h-screen bg-stone-50 text-gray-900" style={{fontFamily: "'Georgia', serif"}}>
      ...
      <nav className={`sticky top-0 z-50 transition-all duration-300 ${scrolled ? "bg-white shadow-md" : "bg-white/90 backdrop-blur-sm"} border-b border-stone-200`}>
        <div className="max-w-5xl mx-auto px-4 sm:px-8 py-3 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8" style={{fontFamily: "sans-serif"}}>
            ...
            <a href="/previous" className="text-sm font-bold transition-colors" style={{color: "#c2446e"}}>Previously Listed</a>
        ...
        {menuOpen && (
          <div className="md:hidden bg-white border-t border-stone-100 px-6 py-4 flex flex-col gap-4 text-sm text-stone-600" style={{fontFamily: "sans-serif"}}>
            ...
            <a href="/previous" className="py-1 font-bold" style={{color: "#c2446e"}}>Previously Listed</a>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-8 pt-10 sm:pt-14 pb-6">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold text-stone-900 mb-4" style={{letterSpacing: "-0.5px"}}>Previously Listed</h1>
        <p className="text-stone-500 text-base leading-relaxed max-w-2xl" style={{fontFamily: "sans-serif"}}>
          Homes found and families settled. Every one of these apartments was listed and placed by Aimee — a small window into 20+ years of work across New York City.
        </p>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-8 pb-16">
        ...
        <div className="mt-12 bg-white rounded-xl p-6 sm:p-8 border border-stone-200 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-5" style={{fontFamily: "sans-serif"}}>
            <a href="/listings" className="text-white font-semibold px-7 py-3 rounded-full text-sm hover:opacity-90 transition-opacity" style={{backgroundColor: "#c2446e"}}>See Current Listings</a>
            <a href="tel:+16462419797" className="font-semibold px-7 py-3 rounded-full text-sm border border-stone-300 text-stone-600 hover:bg-stone-100 transition-colors">(646) 241-9797</a>
          </div>
        </div>
      </div>
